...
class ConfirmServiceTest {
    ...
    void requestConfirmTest(){
        ...
        RequestConfirmDto dto = RequestConfirmDto.builder()
                .fromEmpNo(i)
                .toEmpNo(6)
                .conTitle("[제목] 테스트 결재 요청 " + 4 + i)
                .conContent("[내용] 테스트 결재 내용 "+ 4 + i)
                .build();
    ...
    void getWaitingListTest2(){
        List<Confirm> list = confirmService.getWaitingList(6L, 11111L);
        System.out.println(list);
    ...
    void getCheckedList1(){
        List<Confirm> checkedList = confirmService.getCheckedList(6L, 11111L);
    ...
    void getCheckedLis2t(){
        List<Confirm> checkedList = confirmService.getCheckedList(3L, null);
        System.out.println(checkedList);
