...
<head>
    ...
    <style>
        ...
        .change-pwd-box label h3,
        .change-info-box label h3 {
            padding: 5px 0;
            margin: 0;
            font-size: 1em;
        }
        ...
        #savePwd-button,
        #cancelChangePwd-button,
        #check-currentPwd-button,
        #cancel-currentPwd-button {
            margin-right: 20px;
            margin-top: 20px;
            width: 100px;
            height: 40px;
        ...
        .modify-my-info-wrapper #change-phone,
        #change-pwd {
            width: 40%;
            margin: 0 auto 30px;
            display: flex;
        ...
        .modify-my-info-wrapper #change-phone label,
        #change-pwd label {
            font-size: 1.4em;
            font-weight: 700;
            margin: 0 auto;
        ...
        $saveButton.onclick = e => {
            ...
            fetch('/hrms/employees/updatePhoneNumber', {
                ...
                if (response.ok) {
                    ...
                    document.getElementById('left-banner-emp-phone').querySelector('span').textContent =
                        newPhoneNumber;
                    // location.reload();
                    $closeUpdatePhoneModal.style.display = 'none';
                } else {
    ...
    const $changePwdImage = document.getElementById('pwd-img');
        ...
        $changePwdInput.onkeyup = () => {
            ...
            if (newPassword.trim() === '') {
                ...
                $checkPwdInput.textContent = '<b style="color: red;">[비밀번호는 필수값입니다!]</b>';
            } else {
                $changePwdInput.style.borderColor = 'skyblue';
                $checkPwdInput.textContent = '<b style="color: skyblue;">[사용가능한 비밀번호입니다.]</b>';
            }
        ...
        $checkPwdInput.onkeyup = () => {
            ...
            // console.log($checkPwdInput.value + '11');
            // console.log(checkPassword + ' secondvalue');

            if (checkPassword.trim() === '') {
                $checkPwdInput.style.borderColor = 'red';
                document.getElementById('check-pwd-input').textContent =
